  ...
  <q-page class="column items-center justify-evenly" padding>
    <header class="header">
      ...
      <div class="description">
        Your AI assistant will recursively use tools (e.g. search...) to achieve
    ...
    <q-card>
      <q-card-section>
        ...
        <q-input
          ...
          hint="Give your AI an meaningful name"
          :hide-hint="true"
        />
        <q-input
          filled
          v-model="role"
          label="Role"
          :placeholder="demo.role"
          hint="Describe the role of your AI"
          :hide-hint="true"
        />
      ...
      <q-card-actions align="around">
        <q-btn
          ...
          >Demo values</q-btn
        >
        <q-btn flat color="primary" title="Run the task" @click="run"
          >Run</q-btn
        >
      </q-card-actions>
    </q-card>
